...
# Last updated: 2026-07-12 18:53:25
# Files: 106
# Lines of code: ~8332
```
- **/components**
...
- **/engine**
  ...
  - **/texture**
    ...
    - [boxMapping.ts](../src/engine/texture/boxMapping.ts)
      ...
      - Function: `buildAtlas` - Rasterizes the 6 texture faces into a single RG...
    ...
    - [types.ts](../src/engine/texture/types.ts)
      ...
      - Variable: `GRAYSCALE` - The texture palette — for now, the first 5 gray...
