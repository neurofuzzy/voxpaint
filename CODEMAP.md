...
# Last updated: 2026-07-13 00:43:17
# Files: 118
# Lines of code: ~9544
```
- **/components**
  ...
  - **/viewport3d**
    ...
    - [OptimizedMeshView.tsx](../src/components/viewport3d/OptimizedMeshView.tsx)
      ...
      - Function: `OptimizedMeshView` - Renders the whole model as shell-culled, coplan...
...
- **/engine**
  ...
  - **/instancing**
    ...
    - [voxelMeshBuilder.ts](../src/engine/instancing/voxelMeshBuilder.ts)
      ...
      - Interface: `MaterialGroupGeometry`
      - Interface: `OptimizedVoxelGroups`
      - Function: `buildOptimizedVoxelGroups` - Build the model split into **one optimized, ver...
      - Function: `buildOptimizedVoxelGeometryByMaterial` - Per-material-class optimized geometries (≤4) fo...
