...
# Last updated: 2026-09-14 01:43:31
# Files: 189
# Lines of code: ~20645
```
- **/assets**
- **/components**
  - **/editor2d**
    - [cameraTransform.test.ts](../src/components/editor2d/cameraTransform.test.ts)
    - [cameraTransform.ts](../src/components/editor2d/cameraTransform.ts)
      - Interface: `CanvasSize`
      - Interface: `CanvasPan`
      - Interface: `TouchPoint` - Canvas-local (post-`getBoundingClientRect` subt...
      - Function: `touchMidpoint` - Midpoint of a two-finger touch, in the same can...
      - Function: `touchDistance` - Distance between two touch contacts, in canvas-...
      - Function: `vScaleForPlane` - V-axis display stretch for a construction plane...
    ...
    - [canvasConstants.ts](../src/components/editor2d/canvasConstants.ts) - Grid-cell size in CSS px at 100% zoom (1.0). Ce...
      ...
      - Variable: `TOUCH_GESTURE_DELAY_MS` - How long a solo touch waits before it commits t...
      - Function: `clampZoom`
  ...
  - **/layout**
    ...
    - [TopToolbar.tsx](../src/components/layout/TopToolbar.tsx)
      - Function: `TopToolbar`
  - **/onboarding**
    - [HelpButton.tsx](../src/components/onboarding/HelpButton.tsx)
      - Function: `HelpButton` - Top-toolbar button that opens the keyboard-shor...
    ...
    - [SplashDialog.tsx](../src/components/onboarding/SplashDialog.tsx)
      - Function: `SplashDialog` - First-run welcome screen: the VoxPaint logo, la...
    - [tourSteps.ts](../src/components/onboarding/tourSteps.ts) - Preferred side to float a tour callout relative...
  ...
  - **/panels**
    ...
    - [ExportStlDialog.tsx](../src/components/panels/ExportStlDialog.tsx)
      - Function: `ExportStlDialog`
    ...
    - [NewProjectDialog.tsx](../src/components/panels/NewProjectDialog.tsx)
      - Function: `NewProjectDialog` - New Project modal: optional name + a locked-in-...
    - [PaletteThemeMenu.tsx](../src/components/panels/PaletteThemeMenu.tsx)
      - Function: `PaletteThemeMenu` - Theme chooser: applies a pre-made palette's col...
    - [ProjectSettingsDialog.tsx](../src/components/panels/ProjectSettingsDialog.tsx)
      - Function: `ProjectSettingsDialog` - Project Settings modal: rename the project, res...
    - [projectSizeOptions.ts](../src/components/panels/projectSizeOptions.ts)
      - Variable: `SIZE_OPTIONS`
      - Variable: `CUSTOM_MIN` - Inclusive range for a custom cube size. Odd val...
      - Variable: `CUSTOM_MAX`
      - Function: `parseCustomSize`
    - [ProjectSizePicker.tsx](../src/components/panels/ProjectSizePicker.tsx)
      - Function: `ProjectSizePicker` - Shared project-size picker: the Small/Medium/La...
    - [SelectionPalette.tsx](../src/components/panels/SelectionPalette.tsx)
      - Function: `SelectionPalette` - Replaces the color palette while the Select too...
  ...
  - **/viewport3d**
    ...
    - [Compass.tsx](../src/components/viewport3d/Compass.tsx)
      - Function: `CompassTracker` - Headless — lives inside `<Canvas>` purely to re...
      - Function: `CompassIcon` - Plain DOM overlay — render as a sibling of `<Ca...
    ...
    - [EmissiveAnimationSettings.tsx](../src/components/viewport3d/EmissiveAnimationSettings.tsx)
      - Function: `EmissiveAnimationSettings` - Animate mode's `SettingsPalette` content: per-e...
    - [ExposureSlider.tsx](../src/components/viewport3d/ExposureSlider.tsx)
    ...
    - [OptimizedMeshView.tsx](../src/components/viewport3d/OptimizedMeshView.tsx)
      - Function: `OptimizedMeshView` - Renders the whole model split into **one mesh p...
    - [PivotGizmo.tsx](../src/components/viewport3d/PivotGizmo.tsx)
      - Function: `PivotGizmo` - Small marker at the current construction-plane ...
    - [ProjectBoundsBox.tsx](../src/components/viewport3d/ProjectBoundsBox.tsx)
      - Function: `ProjectBoundsBox` - Subtle wireframe box around the project's worki...
    ...
    - [SelectionHighlight.tsx](../src/components/viewport3d/SelectionHighlight.tsx)
      - Function: `SelectionHighlight` - Casts the 2D canvas's selection cyan over the a...
    - [SettingsPalette.tsx](../src/components/viewport3d/SettingsPalette.tsx)
      - Function: `SettingsPalette` - Contextual per-mode settings palette: each auth...
    - [TexturedModelView.tsx](../src/components/viewport3d/TexturedModelView.tsx)
      - Function: `TexturedModelView` - Texture-mode 3D preview: box-mapped, shell-cull...
    - [TextureSettings.tsx](../src/components/viewport3d/TextureSettings.tsx)
      - Function: `TextureSettings` - Texture-mode settings: baked noise (AO texture ...
    - [useGhostGroup.ts](../src/components/viewport3d/useGhostGroup.ts)
      - Function: `useGhostGroup` - Renders a set of `GhostBatch`es into a `THREE.G...
    - [usePreviewAOMaps.ts](../src/components/viewport3d/usePreviewAOMaps.ts)
      - Type: `PreviewAOMaps`
      - Function: `usePreviewAOMaps` - Shared AO + specular-noise texture baking for t...
    - [useSlotMaterialMaps.ts](../src/components/viewport3d/useSlotMaterialMaps.ts)
      - Function: `useSlotMaterialMaps` - Resolves a set of builtin material ids to their...
...
- **/engine**
  - **/animation**
    - [animatedPreviewBuild.ts](../src/engine/animation/animatedPreviewBuild.ts)
      - Type: `AnimatedSliceMeshes`
      - Function: `buildAnimatedSliceMeshes` - Partitions the model into per-slice animation n...
    ...
    - [animationLayers.ts](../src/engine/animation/animationLayers.ts)
      ...
      - Function: `hasActiveAnimations` - True iff at least one slice has an active (non-...
      - Function: `isSlideMode`
      - Function: `isRotateMode`
      - Function: `isPendulumMode`
      - Function: `slideDirection` - Signed direction vector for a slide mode: base ...
      - Function: `sliceVoxelKeys`
      - Function: `bboxCenterOfKeys`
      - Function: `sliceBBoxCenter`
      - Function: `resolveAnimCenter` - Rotation/pendulum node center: an explicit per-...
      - Function: `sliceWorldBasis`
      - Variable: `BASE_CYCLE_SECONDS` - Shared with the glTF export (animationGLTF.ts) ...
      - Function: `updateAnimatedGroupTransform` - Per-frame transform for one animated slice grou...
      - Function: `assignVoxelsToNodes`
      - Function: `defaultAnimationSettings`
      - Variable: `SLIDE_AMOUNT_MIN`
      - Variable: `SLIDE_AMOUNT_MAX`
      - Variable: `PENDULUM_AMOUNT_MIN`
      - Variable: `PENDULUM_AMOUNT_MAX`
  ...
  - **/ao**
    ...
    - [bakeAO.ts](../src/engine/ao/bakeAO.ts)
      ...
      - Function: `generateNoiseSeed` - Fresh random per-project noise seed, generated ...
  ...
  - **/chamfer**
    ...
    - [chamferGeometry.ts](../src/engine/chamfer/chamferGeometry.ts)
      ...
      - Function: `thinGeometry` - Model F — thin slab: a full-footprint box that ...
      ...
      - Function: `wedgeGeometry` - Model E — corner wedge: a flat diagonal cut, co...
  ...
  - **/export**
    - [emissiveAnimationExport.ts](../src/engine/export/emissiveAnimationExport.ts)
      - Type: `EmissiveAnimExportTarget`
      - Function: `registerEmissiveAnimationExtension` - Registers a `GLTFExporter` plugin that bakes ea...
    - [gltfExport.test.ts](../src/engine/export/gltfExport.test.ts)
    ...
    - [scaleGeometry.ts](../src/engine/export/scaleGeometry.ts)
      - Function: `scaleGeometryY` - Bakes the project-level Y voxel scale into alre...
    - [stlExport.test.ts](../src/engine/export/stlExport.test.ts)
    - [stlExport.ts](../src/engine/export/stlExport.ts)
      - Type: `StlExportAnchor` - STL export — a print-oriented sibling of `gltfE...
      - Type: `StlExportOptions`
      - Function: `exportModelToStl` - Build the export scene and serialize it to a bi...
      - Function: `downloadStl` - Trigger a browser download of a binary .stl Arr...
    - [voxelScaleY.test.ts](../src/engine/export/voxelScaleY.test.ts)
  - **/grid**
    - [GridStore.test.ts](../src/engine/grid/GridStore.test.ts)
    - [GridStore.ts](../src/engine/grid/GridStore.ts)
      ...
      - Variable: `DEFAULT_GRID_EXTENT` - Default working span used only before a project...
      - Function: `effectiveExtent` - The even grid the engine actually works on. The...
      - Function: `viewOriginShift` - Half-cell the 2D/3D views nudge their framing (...
      - Function: `withinWorkingBounds` - Absolute box centered on the origin (spec §1.1:...
      - Function: `countCellsOutsideBounds` - Counts the model's cells (color layer; every ch...
      - Function: `clampPlaneOffset` - Clamps a construction-plane offset into the pro...
    - [types.ts](../src/engine/grid/types.ts)
      - Type: `Axis`
      - Type: `Orientation`
      - Type: `Rotation`
      - Type: `ChamferShapeKind`
      - Type: `GridExtent` - Locked-in project size (edge length of the work...
      - Type: `VoxelScaleY` - Project-level Y voxel scale: world height of on...
  ...
  - **/instancing**
    ...
    - [ghostBatches.test.ts](../src/engine/instancing/ghostBatches.test.ts)
    - [ghostBatches.ts](../src/engine/instancing/ghostBatches.ts)
      - Type: `GhostBatch` - One instanced draw's worth of overlay cells: ev...
      - Function: `buildFloatGhostBatches` - Lays out the floating selection for rendering a...
      - Function: `buildSelectionHighlightBatches` - Lays out the voxels under a (non-floating) sele...
    ...
    - [meshOptimizer.ts](../src/engine/instancing/meshOptimizer.ts)
      ...
      - Function: `removeOccludedGlassFaces` - Strips triangles of a (post-CSG, pre-coplanar-m...
    - [pools.ts](../src/engine/instancing/pools.ts)
      - Type: `PoolId` - The instancing pools every voxel render path dr...
      - Variable: `POOL_IDS`
      - Function: `poolIdFor` - The pool a color cell belongs to, accounting fo...
      - Function: `buildPoolGeometries` - One fresh geometry per pool. Callers own what t...
    - [previewMaterial.ts](../src/engine/instancing/previewMaterial.ts)
      - Type: `PreviewMaterialOptions`
      - Function: `tickEmissiveAnimation` - Advances one material's live blink/pulse, if `b...
      - Function: `materialDefForGroup` - Resolves a group's material definition from its...
      - Function: `buildPreviewMaterial` - One `MeshPhysicalMaterial` per (materialClass, ...
    ...
    - [voxelMeshBuilder.ts](../src/engine/instancing/voxelMeshBuilder.ts)
      ...
      - Interface: `ColorGroupGeometry`
      - Function: `materialIdForSlot` - Resolves a cell's assigned material id: the slo...
  ...
  - **/materials**
    - [builtinMaterials.test.ts](../src/engine/materials/builtinMaterials.test.ts)
    - [builtinMaterials.ts](../src/engine/materials/builtinMaterials.ts) - Built-in PBR surface materials: curated texture...
      - Type: `BuiltinMaterialDef`
      - Variable: `BUILTIN_MATERIALS`
      - Variable: `BUILTIN_MATERIAL_BY_ID`
      - Variable: `CLASS_MATERIAL_IDS` - Parametric class assignments: the material row'...
      - Type: `ClassMaterialId`
      - Variable: `CLASS_MATERIAL_NAMES`
      - Function: `isClassMaterialId`
      - Function: `effectiveMaterialClass` - A slot's effective material class: a class-id a...
      - Function: `slotMaterialKey` - `"<kind>:<index>"` key under which a slot's mat...
      - Type: `SlotMaterialAssignments` - Per-slot builtin-material assignments: slot key...
    - [materialMaps.ts](../src/engine/materials/materialMaps.ts)
      - Type: `SlotMaterialMaps` - Resolved GPU textures for one builtin material ...
      - Function: `loadMaterialMaps` - Loads (and downscales) a builtin material's map...
  - **/palette**
    ...
    - [emissiveAnimation.ts](../src/engine/palette/emissiveAnimation.ts)
      - Variable: `EMISSIVE_ANIM_CYCLE_SECONDS` - Blink/pulse both cycle once per second, live-pr...
      - Function: `buildEmissiveAnimIndex` - Maps each animated emissive slot's resolved col...
      - Function: `emissiveAnimFactor` - 0..1 intensity multiplier at `elapsedSeconds` f...
    - [palette.test.ts](../src/engine/palette/palette.test.ts)
    - [palette.ts](../src/engine/palette/palette.ts)
      ...
      - Function: `darkestBaseColor` - The darkest swatch in the base (matte) palette ...
    - [themes.ts](../src/engine/palette/themes.ts)
      - Type: `PaletteTheme` - Pre-made themed palettes, generated from a cura...
      - Variable: `PALETTE_THEMES`
    - [types.ts](../src/engine/palette/types.ts) - A palette slot's kind also selects its **materi...
      ...
      - Type: `PaletteSlotRef`
      - Type: `EmissiveAnimMode` - Per-emissive-slot glow animation, both live-pre...
      - Type: `PaletteState`
  - **/persistence**
    ...
    - [schema.ts](../src/engine/persistence/schema.ts)
      ...
      - Type: `EnvironmentChoice` - IBL environment source for the 3D preview: `neu...
      - Type: `ViewSettings`
      - Type: `ProjectMeta`
      ...
      - Type: `SerializedSlicePivot` - A slice's rotation/pendulum pivot override: the...
    ...
    - [uiPrefs.ts](../src/engine/persistence/uiPrefs.ts) - App-level UI preferences, persisted outside the...
      - Type: `UiPrefs`
      - Function: `loadUiPrefs` - Reads persisted UI prefs, falling back to defau...
      - Function: `saveUiPrefs` - Persists UI prefs. Swallows storage errors (pri...
    - [voxelScaleY.test.ts](../src/engine/persistence/voxelScaleY.test.ts)
  - **/plane**
    ...
    - [planeDisplay.ts](../src/engine/plane/planeDisplay.ts)
      ...
      - Function: `toDisplayGridlineU` - The `toDisplayU`/`toDisplayV` counterparts for ...
      - Function: `toDisplayGridlineV` - The v counterpart to `toDisplayGridlineU` — see...
  ...
  - **/texture**
    ...
    - [boxMapping.ts](../src/engine/texture/boxMapping.ts)
      - Function: `atlasDimsFor` - Atlas pixel dimensions for a project's `gridExt...
      ...
      - Function: `materialUVForVertex` - Plain per-face 0..1 box-map UV for builtin mate...
    ...
    - [overlay.ts](../src/engine/texture/overlay.ts)
      - Function: `overlayChannel` - Overlay one sRGB channel (`base`) with a `blend...
      - Function: `bakeOverlayTexture` - Bake `overlay(color, blend)` into an sRGB RGBA ...
      - Function: `bakeOverlayTexturesByColor` - Bakes one overlay texture per distinct `colorKe...
    ...
    - [texelOps.ts](../src/engine/texture/texelOps.ts)
      ...
      - Function: `rotateClip90` - Rotate a clip 90° (extents swap) — mirrors `rot...
    ...
    - [texturedGeometry.ts](../src/engine/texture/texturedGeometry.ts)
      ...
      - Function: `materialUVForExtent` - Material-map UV generator for the CSG-optimized...
    - [TextureStore.ts](../src/engine/texture/TextureStore.ts)
      - Function: `texelIndex` - Flat index into a face's texel array for texel ...
      - Function: `withinFace` - True when (u, v) is inside a face's `faceSize²`...
      - Function: `emptyTextureModel` - A fresh texture with all six faces unpainted (`...
      - Function: `resizeTextureModel` - Re-houses a texture's six faces for a new proje...
    ...
    - [types.ts](../src/engine/texture/types.ts)
      ...
      - Function: `faceSizeFor` - Texels along one edge of a single box face for ...
      - Function: `halfWorldFor` - Half the (even) working volume in world units —...
  ...
  - **/tools**
    - [clipboard.test.ts](../src/engine/tools/clipboard.test.ts)
    - [clipboard.ts](../src/engine/tools/clipboard.ts)
      - Function: `copyRegionToClipboard` - Snapshots a selection off the active plane. The...
      ...
      - Function: `transformClipboardToPlane` - Re-expresses clipboard content copied off one c...
    ...
    - [floodFill.ts](../src/engine/tools/floodFill.ts)
      ...
      - Function: `fillLeaksToEdges` - True when a flood-fill result touches all 4 edg...
      - Function: `floodFillRegion3D` - 6-connected flood fill through the full 3D Voxe...
    - [index.ts](../src/engine/tools/index.ts)
      - Variable: `toolMap`
      - Variable: `animateToolMap` - Animate-mode tool dispatch: paint/erase/pivot h...
    ...
    - [paintTool.ts](../src/engine/tools/paintTool.ts)
      - Variable: `paintTool`
    - [pivotTool.ts](../src/engine/tools/pivotTool.ts)
      - Variable: `pivotTool` - Animate-mode-only: click sets (replacing any ex...
    - [selectionMask.test.ts](../src/engine/tools/selectionMask.test.ts)
    - [selectionMask.ts](../src/engine/tools/selectionMask.ts)
      ...
      - Function: `rotateRegion90` - Rotates a selection mask 90° in place (origin c...
    ...
    - [transform.ts](../src/engine/tools/transform.ts)
      ...
      - Function: `rotateClipboard90` - Rotates clipboard content 90° around its own bo...
      - Function: `mirrorClipboard` - Mirrors clipboard content across its own boundi...
...
- **/store**
  ...
  - [environment.test.ts](../src/store/environment.test.ts)
  ...
  - [paintActions.test.ts](../src/store/paintActions.test.ts)
  ...
  - [planeSlice.test.ts](../src/store/planeSlice.test.ts)
  ...
  - [slotMaterials.test.ts](../src/store/slotMaterials.test.ts)
  ...
  - [toolActionsSlice.test.ts](../src/store/toolActionsSlice.test.ts)
  ...
  - [types.ts](../src/store/types.ts)
    ...
    - Type: `SelectionTransformKind` - `rotate` is the clockwise quarter-turn (the bar...
  ...
  - [voxelScaleY.test.ts](../src/store/voxelScaleY.test.ts)
