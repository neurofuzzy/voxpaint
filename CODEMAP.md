...
# Last updated: 2026-09-14 01:20:32
# Files: 189
# Lines of code: ~20566
```
- **/assets**
...
- **/engine**
  ...
  - **/instancing**
    ...
    - [voxelMeshBuilder.ts](../src/engine/instancing/voxelMeshBuilder.ts)
      ...
      - Interface: `ColorGroupGeometry`
      - Function: `materialIdForSlot` - Resolves a cell's assigned builtin material: th...
  ...
  - **/materials**
    ...
    - [builtinMaterials.ts](../src/engine/materials/builtinMaterials.ts) - Built-in PBR surface materials: curated texture...
      - Type: `BuiltinMaterialDef` - Built-in PBR surface materials: curated texture...
