...
# Last updated: 2026-09-23 07:14:54
# Files: 197
# Lines of code: ~21932
```
- **/assets**
...
- **/engine**
  ...
  - **/chamfer**
    ...
    - [faceBasis.test.ts](../src/engine/chamfer/faceBasis.test.ts)
    - [faceBasis.ts](../src/engine/chamfer/faceBasis.ts)
      - Function: `rebaseChamferCell` - Re-authors one chamfer cell onto a new authorin...
  ...
  - **/instancing**
    ...
    - [meshOptimizer.ts](../src/engine/instancing/meshOptimizer.ts)
      ...
      - Function: `mergeCoplanarFacesWithKeys` - Tag-aware coplanar merge: like `mergeCoplanarFa...
    ...
    - [texturedMerge.test.ts](../src/engine/instancing/texturedMerge.test.ts)
    ...
    - [voxelMeshBuilder.ts](../src/engine/instancing/voxelMeshBuilder.ts)
      ...
      - Type: `TexturedFaceTag` - Box-face tag a shell face samples its texture f...
      - Type: `TagForTexturedFace`
  ...
  - **/markers**
    ...
    - [markers.ts](../src/engine/markers/markers.ts)
      - Function: `createMarker` - Creates a marker at a grid cell with the given ...
      - Function: `markerColorHex` - Resolves a marker's color index to its hex stri...
      ...
      - Function: `markerDirectionWord` - Human direction word for a marker's facing (mat...
      - Function: `markerNodeName` - Unique glTF node name for a marker: color hex +...
    - [types.ts](../src/engine/markers/types.ts)
      - Variable: `MARKER_COLORS` - The fixed marker color set. Markers deliberatel...
      - Type: `MarkerColor` - Index into `MARKER_COLORS`.
      - Type: `Marker` - A design marker: a colored, oriented, non-voxel...
  ...
  - **/texture**
    ...
    - [texturedGeometry.ts](../src/engine/texture/texturedGeometry.ts)
      ...
      - Function: `buildTexturedGeometryByColorMerged` - Model-mode preview geometry for textured models...
