...
export const createViewSlice: Slice = (set) => ({
  ...
  setTextureFaceMap: (v) => set((state) => { state.textureFaceMap = v }),
  ...
  setExportIncludeMarkers: (v) => set((state) => { state.exportIncludeMarkers = v; state.dirty = true }),
})
