 ...
 * `planeGeometry` (default +Z normal) into that face's plane. `half` is the project's own
 * `meta.gridExtent / 2` — the working-volume box's half-edge. */
function facesFor(half: number): { face: BoxFace; position: [number, number, number]; rotation: [number, number, number] }[] {
  return [
    { face: 'px', position: [half, 0, 0], rotation: [0, Math.PI / 2, 0] },
    { face: 'nx', position: [-half, 0, 0], rotation: [0, -Math.PI / 2, 0] },
    { face: 'py', position: [0, half, 0], rotation: [-Math.PI / 2, 0, 0] },
    { face: 'ny', position: [0, -half, 0], rotation: [Math.PI / 2, 0, 0] },
    { face: 'pz', position: [0, 0, half], rotation: [0, 0, 0] },
    { face: 'nz', position: [0, 0, -half], rotation: [0, Math.PI, 0] },
  ]
}
